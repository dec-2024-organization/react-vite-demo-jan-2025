  ...
  let mappedAllBooks = allBooks.map((book) => {
    return (
      <tr key={book.id}>
        ...
        <td>
          <button className="btn btn-info" onClick={() => editBook(book.id)}>
            Edit
          </button>
        </td>
        <td>
